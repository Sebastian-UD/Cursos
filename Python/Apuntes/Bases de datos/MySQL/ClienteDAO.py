...
class ClienteDAO:
    ...
    def insertar(cls, cliente):
        ...
        try:
            ...
            conexion.commit()
            # Retorna el numero de registros insertados en la BD
    ...
    def actualizar(cls, cliente):
        ...
        try:
            ...
            conexion.commit()
            # Retorna el numero de registros actualizados en la BD
            return cursor.rowcount
    ...
    def eliminar(cls, cliente):
        ...
        try:
            ...
            # Retorna el numero de registros eliminados en la BD
            return cursor.rowcount
        except Exception as e:
